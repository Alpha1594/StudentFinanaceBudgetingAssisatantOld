namespace StudentFinanaceBudgetingAssisatant
{
    partial class Config
    {
        ...
        private void InitializeComponent()
        {
            ...
            // TabDates
            // 
            this.TabDates.Controls.Add(this.label6);
            this.TabDates.Controls.Add(this.label5);
            this.TabDates.Controls.Add(this.label4);
            this.TabDates.Controls.Add(this.label3);
            this.TabDates.Controls.Add(this.label2);
            this.TabDates.Controls.Add(this.label1);
